...
ฑฑบ Desenvolvedor ณ Eduardo Augusto      บ Empresa ณ EV Solu็๕es Intelig  บฑฑ
ฑฑบ Alterado por  ณ Valdemir Jose        บ Empresa ณ EV Solu็๕es Intelig  บฑฑ
...
IF SEE->(DbSeek(xFilial("SEE") + _cBanco + _cAgencia + _cConta + _cSubcta ))
	//Processamento da gera็ใo de boletos
...
ฑฑบPrograma  ณBOLETOS   บAutor  ณEV Solucoes         บ Data ณ  06/08/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Impressao de Boeltos                                       บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบManutencaoณ Eduardo / Valdemir                                         บฑฑ
...
For i := 1 to Len(aVetor)
	...
	If aVetor[i,1] == .T.
		...
		// Impressao
		oPrint := FWMSPrinter():New(cArquivo, IMP_PDF, lAdjustToLegacy,, lDisableSetup,,,,,,,.F.,)// Ordem obrigแtoria de configura็ใo do relat๓rio
		...
		If _cBanco = "399"
			oPrint:Say(0036,0110, "|" + "399" + "-" + "9" + "|" ,oFont18N,100)	// C๓digo do Banco + Dํgito
		ElseIf _cBanco = "341"
		...
		BuzzBox  (0040,0025,0065,0250)	// Box Beneficiแrio + Cnpj
		...
		oPrint:Say (0056,0166,Transform(cCgcSM0,"@R 99.999.999/9999-99"),oFont06) //Cnpj do Beneficiแrio
		BuzzBox  (0040,0250,0065,0350)	// Box Agencia / Codigo do Cedente
		oPrint:Say (0046, 0251,"Ag๊ncia/C๓digo de Cedente",oFont06N )
		...
		BuzzBox  (0040,0350,0065,0450)	// Nฐ do Documento
		oPrint:Say (0046, 0351,"Nฐ do Documento",oFont06N )
		...
		oPrint:Say (0070, 0451,"(  )Nใo existe nบ indicado"	,oFont06N,100)
		oPrint:Say (0080, 0451,"(  )Recusado"               ,oFont06N,100)
		oPrint:Say (0090, 0451,"(  )Nใo procurado"          ,oFont06N,100)
		oPrint:Say (0100, 0451,"(  )Endere็o insuficiente"  ,oFont06N,100)
		...
		If _cBanco = "399"
			oPrint:Say(0176,0110, "|" + "399" + "-" + "9" + "|" ,oFont18N,100)	// C๓digo do Banco + Dํgito
		ElseIf _cBanco = "341"
		...
		oPrint:Say (0221,0301,Transform(cCgcSM0,"@R 99.999.999/9999-99"),oFont06) //Cnpj do Beneficiแrio
		BuzzBox  (0205,0425,0230,0560)	// Agencia 	/ Codigo do Cedente
		oPrint:Say (0211, 0426,"Ag๊ncia/C๓digo de Cedente",oFont06N )
		If _cBanco = "399"
		...
		oPrint:Say  (0316,0026,"Ap๓s vencimento cobrar mora de R$ ..... " + Alltrim(Transform(((Iif(SE1->E1_PREFIXO<>"RPS",SE1->E1_SALDO,SE1->E1_SALDO - (SE1->E1_CSLL +SE1->E1_COFINS +SE1->E1_PIS +SE1->E1_IRRF +SE1->E1_INSS))* _nJuros)/100)/30,"@E 99,999,999.99"))+ " ao dia", oFont08,100)
		oPrint:Say  (0326,0026,"Ap๓s " + DtoC(SE1->E1_VENCREA) + " cobrar multa de R$ " + Alltrim(Transform(((Iif(SE1->E1_PREFIXO<>"RPS",SE1->E1_SALDO,SE1->E1_SALDO - (SE1->E1_CSLL +SE1->E1_COFINS +SE1->E1_PIS +SE1->E1_IRRF +SE1->E1_INSS))* _nMulta)/100),"@E 99,999,999.99")), oFont08,100)
		...
		If _cBanco = "399"
			oPrint:Say(0496,0110, "|" + "399" + "-" + "9" + "|" ,oFont18N,100)	// C๓digo do Banco + Dํgito
		ElseIf _cBanco = "341"
		...
		ElseIf _cBanco = "237"
			...
			//oPrint:Say  (0526, 0096,"APำS O VENCIMENTO, SOMENTE NAS AGENCIAS DO BRADESCO",oFont06N )
		Else
			oPrint:Say  (0516, 0096,"PAGAVEL EM QUALQUER BANCO ATE O VENCIMENTO",oFont06N )
		EndIf
		...
		oPrint:Say (0541,0301,Transform(cCgcSM0,"@R 99.999.999/9999-99"),oFont06) //Cnpj do Beneficiแrio
		BuzzBox  (0525,0425,0550,0560)	// Agencia / Codigo do Cedente
		oPrint:Say (0531, 0426,"Ag๊ncia/C๓digo de Cedente",oFont06N )
		...
		oPrint:Say  (0636,0026,"Ap๓s vencimento cobrar mora de R$ ..... " + Alltrim(Transform(((Iif(SE1->E1_PREFIXO<>"RPS",SE1->E1_SALDO ,SE1->E1_SALDO - (SE1->E1_CSLL +SE1->E1_COFINS +SE1->E1_PIS +SE1->E1_IRRF +SE1->E1_INSS))* _nJuros)/100)/30,"@E 99,999,999.99"))+ " ao dia", oFont08,100)
		oPrint:Say  (0646,0026,"Ap๓s " + DtoC(SE1->E1_VENCREA) + " cobrar multa de R$ " + Alltrim(Transform(((Iif(SE1->E1_PREFIXO<>"RPS",SE1->E1_SALDO, SE1->E1_SALDO  - (SE1->E1_CSLL +SE1->E1_COFINS +SE1->E1_PIS +SE1->E1_IRRF +SE1->E1_INSS))* _nMulta)/100),"@E 99,999,999.99")), oFont08,100)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAddBorderoบAutor  ณEduardo/Valdemir    บ Data ณ  06/08/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Gera Bordero com base nos titulos selecionados             บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
*/
	...
	//ณGera todos o Numero do Bordero na Tabela SE1		                        ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	For nTit := 1 to Len(aVetor)
	    oObj:IncRegua1("Processando, Carregando informa็๕es para Bordero " )
			...
			If SE1->( DbSeek( xFilial("SE1")+ aVetor[nTit][2] + aVetor[nTit][3] + aVetor[nTit][4] + aVetor[nTit][12]) )
				Begin Transaction
				  IF EMPTY(SE1->E1_NUMBOR)
					...
					Endif
                    MsUnlock()
                    // Se nใo foi emitido o bordero atualiza o campo
                    if Empty(SE1->E1_NUMBOR)
				...
				End Transaction
				MsUnlock()
			    oObj:IncRegua2("Gerando o bordero Nบ "+ cNumBor+" Titulo: "+SE1->E1_NUM)
			EndIf
		EndIf
	Next
	// Gera CNAB
...
ฑฑบPrograma ณ BuzzBox         บAutorณ                            บ Data ณ 24/04/2013 บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuncao    ณGetNumBor บAutor  ณ Valdemir Jose      บ Data ณ 07/08/2015  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Retorno o numero do proximo bordero.  					  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ EV Solucoes Inteligentes									  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
//ณ Grava o Nฃmero do bordero atualizado						 ณ
//ณ Posicionar no sx6 sempre usando GetMv. No utilize Seek !!!  ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณGeraCNAB  บAutor  ณEduardo/Valdemir    บ Data ณ  18/08/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Gera Arquivo CNAB                                          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ EV Solucoes Inteligentes									  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
//ณ mv_par13		 // Quebra por ?	  ณ
//ณ mv_par14		 // Seleciona Filial? ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณLIBGERVAL บAutor  ณValdemir Jose       บ Data ณ  05/09/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑบParametro ณ pCompleto - Caminho com arquivo                            บฑฑ
ฑฑบ          ณ nTipo     - 1 = Caminho 2 = Arquivo                        บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบRetorno   ณ Caracter, podendo ser (Caminho / Arquivo)                  บฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณBOLETOS   บAutor  ณValdemir  / Eduardo บ Data ณ  22/09/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta o corpo do e-mail                                    บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ EV Solucoes Inteligentes                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
