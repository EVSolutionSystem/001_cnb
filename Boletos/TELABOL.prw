...
@ 259,0100 SAY "Ag๊ncia: " 	 SIZE 025, 007 OF oDlg  COLORS 0, 16777215 PIXEL
...
@243,460+nColb BUTTON oAjusta   PROMPT "Ajustar" 	  	SIZE 050, 014 Font oDlg:oFont ACTION {if(_Tipo=1,MsgRun("Ajuste utilizado somente para 2บ via.",,{|| Sleep(2000) }), TelaAjuste('J',aVetor, oLbx:nAt)), ,AtuaTela("TMP1",@nItens, @nValores)} OF oDlg PIXEL
